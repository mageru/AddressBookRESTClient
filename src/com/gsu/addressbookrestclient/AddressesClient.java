...
/**
 * Jersey REST client generated for REST resource:AddressesFacadeREST
 * [com.gsu.addressbookrestjson.addresses]<br>
 * USAGE:
 * <pre>
...
public class AddressesClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/AddressBookRESTJSON/webresources";

    public AddressesClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("com.gsu.addressbookrestjson.addresses");
    }
